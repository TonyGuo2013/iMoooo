...
class YafController extends Yaf_Controller_Abstract{
    ...
    protected function checkReferer()
    {
        ...
        {
            $legalHost = array('weibo.com', 'weibo.cn', 'zhaopin.weibo.cn','zhaopin.weibo.com', "pre.zhaopin.weibo.com","www.zhaopin.weibo.com","test.renmai.com","test.weirenmai.web.com");
            $testHost = array('local.weibo.com', 'local.weibo.cn','renmai.weibo.com',
                ...
                'local.zhaopin.weibo.com', "local.wrm.weibo.com","test.renmai.com","test.weirenmai.web.com");
